...
class MentionLeaderboard(discord.ui.View):
...
class mentionleaderboard(commands.Cog):
    ...
    async def mention(self, ctx, member: discord.Member = None):
        ...
        await ctx.send(embed=embed, view=MentionLeaderboard(ctx, member, self.bot))
    ...
    # @commands.command()
    # async def fetchids(self, ctx):
    #     db = sqlite3.connect('messages.db')
    #     cursor = db.cursor()

    #     cursor.execute("""
    #         CREATE TABLE IF NOT EXISTS mentionss(
    #            author INTEGER,
    #            mention INTEGER,
    #            count INTEGER,
    ...
    #     for author, mentioned, count in rows:

    #         print(author, mentioned, count)
    #         mentioned = ctx.guild.get_member_named(mentioned[1:])
    #         print(type(mentioned))
    #         if mentioned is not None:
    #             mentioned = mentioned.id
    #             print(mentioned)
    #             cursor.execute("""
    #                 INSERT OR IGNORE INTO mentionss
    #                 VALUES(?, ?, ?)
    #                 """, (author, mentioned, count))
    #     db.commit()
    #     print("done")
    ...
    #         topten_text += f"`{rank}.`  <@{author}> tagged <@{mention}> **{count}** times \n"
    #         rank += 1
    ...
    # @commands.command()
    # async def tagleaderboard(self, ctx, member: discord.Member = None):
    #     if member is None:
    #         member = ctx.author
    #     db = sqlite3.connect('messages.db')
    #     cursor = db.cursor()
    ...
    # @commands.command()
    # async def myfans(self, ctx, member: discord.Member = None):
    #     if member is None:
    #         member = ctx.author
    #     db = sqlite3.connect('messages.db')
    #     cursor = db.cursor()
    ...
    # @commands.command()
    # async def fanboy(self, ctx, member: discord.Member = None):
    #     if member is None:
    #         member = ctx.author
    #     db = sqlite3.connect('messages.db')
    #     cursor = db.cursor()
